                ...
                <div className={s.execution__box}>
                    <div className={s.execution__info}>
                        <div className={s.execution__list}>
                            ...
                            <p className={s.execution__services}>Срок исполнения до: {this.props.item.dueDate.substr(0,10)}</p>
                        ...
                        {/* <p className={s.execution__user}>Заказчик:  <a href="#" className="execution__link"></a> </p> */}
                    </div>
                    <div className={s.execution__info}>
